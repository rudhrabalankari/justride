...
public class MailUtil {
	final String username = "justriderentalz@gmail.com";
	final String password = "Justride@245";
	...
	public static void main(String[] args) {
		...
		sendMail.sendEmail("mail2rudrasimha@gmail.com", "Rudra", messageBody, subject);
	}
